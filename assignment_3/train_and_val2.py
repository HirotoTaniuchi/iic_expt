...
def training_loop(n_epochs, optimizer, model, loss_fn, train_loader, val_loader):
    ...
    for i in range(n_epochs): 
        ...
        np.save("out_data/ResNet_18_loss", history_losses)
        np.save("out_data/ResNet_18_val", history_val)
    ...
    plt.savefig("out_data/ResNet_18.png")
    plt.show()


    torch.save(model.state_dict(), "out_data/"+"ResNet_18.pt")
...
if __name__=='__main__':
    ...
    model   = model2.ResNet(block=model2.block, num_classes=10) 
